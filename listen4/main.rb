...
#keeper.set_collection_by_type(:station, [station1, station2, station3])
#route = Model::Route.new(station1, station3)
#route.take_point_station(station2)
#keeper.set_collection_by_type(:route, [route])
#cargo_wagon = Model::CargoWagon.new(111)
#passenger_wagon = Model::PassengerWagon.new(222)
#keeper.set_collection_by_type(:wagon, [passenger_wagon, cargo_wagon])
